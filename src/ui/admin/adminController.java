...
//    }
    ...
    // Populates the table with data from a CSV file containing issued books information
...
// Clears the table and reloads data every 60 seconds
 // Updates the current date and time on the UI

...
// The Book class represents a book entity with properties such as ID, name, category, and availability.
public class Book {
    // Properties to hold book information, using SimpleStringProperty for JavaFX bindings
